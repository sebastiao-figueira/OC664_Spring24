...
The combined wave friction and ripples part requires as inputs:
  T_cu: partial crest period
  T_c: crest half cycle period
  T_tu: partial trough period
  T_t: trough half cycle period
  a_hat: a representative wave orbital excursion amplitude
...
The combined wave friction and ripples function outputs:
...
The portions of the code which reflect current related friction factors are documented in Maggie Libby's folder and respective readme file.
